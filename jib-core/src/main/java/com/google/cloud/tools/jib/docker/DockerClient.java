...
public class DockerClient {
    ...
    /**
     * Instantiates with the default {@code docker} executable and custom environment variables
     *
     * @param environment environment variables for {@code docker}
     * @return a new {@link DockerClient}
     */
    public static DockerClient newClient(Map<String, String> environment) {
        return new DockerClient(defaultProcessBuilderFactory(DEFAULT_DOCKER_CLIENT, environment));
    }
